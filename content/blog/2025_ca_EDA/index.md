...
```
    ...
    loaded via a namespace (and not attached):
     ...
     [55] mgcv_1.9-1          xfun_0.50           TTR_0.24.4         
     [58] withr_3.0.2         fastmap_1.2.0       blogdown_1.20      
     [61] digest_0.6.37       timechange_0.3.0    R6_2.5.1           
     [64] textshaping_0.4.1   colorspace_2.1-1    wk_0.9.4           
     ...
     [79] GPfit_1.0-8         lmtest_0.9-40       furrr_0.3.1        
     [82] htmltools_0.5.8.1   tseries_0.10-58     automap_1.1-12     
     [85] png_0.1-8           doSNOW_1.0.20       gower_1.0.2        
     [88] rstudioapi_0.17.1   tzdb_0.4.0          nlme_3.1-166       
     [91] spacetime_1.3-2     curl_6.1.0          repr_1.1.7         
