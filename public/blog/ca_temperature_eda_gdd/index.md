...
```
    ...
    loaded via a namespace (and not attached):
     ...
     [58] mgcv_1.9-1          TTR_0.24.4          withr_3.0.2        
     [61] fastmap_1.2.0       blogdown_1.20       digest_0.6.37      
     [64] timechange_0.3.0    R6_2.5.1            mime_0.12          
     [67] textshaping_0.4.1   colorspace_2.1-1    wk_0.9.4           
     [70] generics_0.1.3      intervals_0.15.5    renv_1.0.7         
     [73] data.table_1.16.4   FNN_1.1.4.1         class_7.3-23       
     [76] prettyunits_1.2.0   httr_1.4.7          pkgconfig_2.0.3    
     [79] gtable_0.3.6        timeDate_4041.110   forecast_8.23.0    
     [82] lmtest_0.9-40       GPfit_1.0-8         furrr_0.3.1        
     [85] htmltools_0.5.8.1   tseries_0.10-58     automap_1.1-12     
     [88] png_0.1-8           doSNOW_1.0.20       gower_1.0.2        
     [91] rstudioapi_0.17.1   tzdb_0.4.0          spacetime_1.3-2    
     [94] nlme_3.1-166        curl_6.1.0          repr_1.1.7         
     [97] proxy_0.4-27        cachem_1.1.0        zoo_1.8-12         
    [100] KernSmooth_2.23-26  parallel_4.4.2      s2_1.1.7           
    [103] pillar_1.10.1       reshape_0.8.9       vctrs_0.6.5        
    [106] ggfittext_0.10.2    lhs_1.2.0           evaluate_1.0.3     
    [109] magick_2.8.5        cli_3.6.3           compiler_4.4.2     
    [112] rlang_1.1.5         crayon_1.5.3        future.apply_1.11.3
    [115] labeling_0.4.3      classInt_0.4-11     plyr_1.8.9         
    [118] stringi_1.8.4       viridisLite_0.4.2   stars_0.6-7        
    [121] assertthat_0.2.1    munsell_0.5.1       Matrix_1.7-2       
    [124] hms_1.1.3           tibbletime_0.1.9    hoardr_0.5.5       
    [127] memoise_2.0.1       quantmod_0.4.26     DiceDesign_1.10    
