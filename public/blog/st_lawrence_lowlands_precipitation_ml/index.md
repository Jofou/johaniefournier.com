...
![](index.markdown_strict_files/figure-markdown_strict/unnamed-chunk-19-1.gif)
...
```
    ...
    [10] htmltools_0.5.8.1   progress_1.2.3      xgboost_1.7.8.1    
    [13] sass_0.4.9          parallelly_1.41.0   StanHeaders_2.32.10
    [16] bslib_0.8.0         KernSmooth_2.23-26  htmlwidgets_1.6.4  
    ...
    [31] crosstalk_1.2.1     textshaping_0.4.1   labeling_0.4.3     
    ...
    [79] systemfonts_1.2.1   jquerylib_0.1.4     repr_1.1.7         
    [82] munsell_0.5.1       Rcpp_1.0.14         globals_0.16.3     
