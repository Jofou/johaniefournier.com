...
gg<-ggplot(data=precipitation_dt_year, aes(x=year, y=sum))+
  geom_line()
```
...
gg<-ggplot(data=precipitation_dt_site, 
...
![](index.markdown_strict_files/figure-markdown_strict/unnamed-chunk-24-1.gif)
...
```
    ...
    loaded via a namespace (and not attached):
     ...
     [10] hoardr_0.5.5        base64enc_0.1-3     blogdown_1.20      
     [13] htmltools_0.5.8.1   progress_1.2.3      curl_6.1.0         
     [16] TTR_0.24.4          sass_0.4.9          parallelly_1.41.0  
     [19] bslib_0.8.0         KernSmooth_2.23-26  htmlwidgets_1.6.4  
     [22] zoo_1.8-12          cachem_1.1.0        ggfittext_0.10.2   
     [25] lifecycle_1.0.4     iterators_1.0.14    pkgconfig_2.0.3    
     [28] Matrix_1.7-2        R6_2.5.1            fastmap_1.2.0      
     [31] digest_0.6.37       colorspace_2.1-1    furrr_0.3.1        
     [34] crosstalk_1.2.1     textshaping_0.4.1   labeling_0.4.3     
